  ...
  return (
    <div className={`navbar-container ${showNav ? 'show' : 'hide'} ${showLinks ? 'shown-links' : 'hidden-links'}` }>
      <div className="main-menu">
        <p className="home" onClick={() => scrollToSectionFct(".hero-container")}>
          <LogoIcon />
        </p>
      ...
      <div className={`sections-link ${showLinks ? 'show-links' : 'hide-links'}`}>
        <p onClick={() => scrollToSectionFct(".skills-container")}><span className="number">01.</span> Skills</p>
        <p onClick={() => scrollToSectionFct(".experience-container")}><span className="number">02.</span> Experience</p>
        <p onClick={() => scrollToSectionFct(".projects-container")}><span className="number">03.</span> Projects</p>
        <p onClick={() => scrollToSectionFct(".about-container")}><span className="number">04.</span> About</p>
      </div>
    </div>
  )
};